...
async def OpenSettings(event: Message, user_id: int):
    try:
        await event.edit(
            text="Settings of the Bot<a href='https://image.tmdb.org/t/p/original/z4CiTwUjQORWH29WFpUmp0q4AAH.jpg'>!</a>",
...
async def VideoSettings(event: Message, user_id: int):
    try:
        ...
        await event.edit(
            text="Here's Your Video Settings<a href='https://image.tmdb.org/t/p/original/z4CiTwUjQORWH29WFpUmp0q4AAH.jpg'>:</a>",
            reply_markup=InlineKeyboardMarkup(
                [
...
async def AudioSettings(event: Message, user_id: int):
    try:
        ...
        await event.edit(
            text="Here's Your Audio Settings<a href='https://image.tmdb.org/t/p/original/z4CiTwUjQORWH29WFpUmp0q4AAH.jpg'>:</a>",
            reply_markup=InlineKeyboardMarkup(
                [
...
async def ExtraSettings(event: Message, user_id: int):
    try:
        await event.edit(
            text="Here's Your Subtitle Settings<a href='https://image.tmdb.org/t/p/original/z4CiTwUjQORWH29WFpUmp0q4AAH.jpg'>:</a>",
            reply_markup=InlineKeyboardMarkup(
                [
                    [InlineKeyboardButton(
